							...
							<div className = 'right-side'>
								<div className = 'row'>
									<div className = "form-group c col-md-6 col-12 mb-3">
								      	...
								      	<input type = "text" className = "form-control py-2 px-3" id = "first_name" placeholder="First Name" value={userData.first_name} onChange={data} required/>
								    </div>
								    <div className = "form-group c col-md-6 col-12 mb-3">
								      	<label htmlFor = "last_name" className = 'mb-2 text-capitalize'>last name</label>
								      	<input type = "text" className = "form-control py-2 px-3" id = "last_name" placeholder="Last Name" value={userData.last_name} onChange={data} required/>
								    </div>
								    <div className = "form-group c col-12 mb-3">
								      	<label htmlFor = "e-mail" className = 'mb-2 text-capitalize'>Email</label>
								      	<input type = "email" className = "form-control py-2 px-3" id = "e-mail" placeholder="Email Address" value={userData.email} onChange={data} required/>
								    </div>
								    <div className = "form-group c col-12 mb-4">
								      	...
								      	<textarea className = "form-control py-2 px-3" id = "textarea" rows = '4' value={userData.message}> </textarea>
								    </div>
